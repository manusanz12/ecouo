		...
		<div class="card-header">
			...
			<div class="col-md-8 offset-md-2">	
				...
				<div class="form-group mt-2">
					...
					<label>Nombre del Servicio <sup class="text-danger">*</sup></label>

					<input 
					type="text" 
					class="form-control"
					pattern="[0-9A-Za-zñÑáéíóúÁÉÍÓÚ ]{1,50}"
					onchange="validateRepeat(event,'text&number','services','name_service')"
					maxlength="50"
					name="name-service"
					required>
				...
				<div class="form-group mt-2">
					...
					<label>Url de servicio <sup class="text-danger">*</sup></label>
				...
				<div class="form-group mt-2">
					...
					<label>Link de servicio <sup class="text-danger">*</sup></label>
		        ...
		        <div class="form-group mt-2">
		            ...
		            <div class="form-group">
		                ...
		                name="name-category"
		                style="width:100%"
		                onchange="changeCategory(event, 'services')"
		                required>
				...
				<div class="form-group mt-2">
					...
					<label>Imagen del servicio <sup class="text-danger">*</sup></label>
			
					<label for="customFile" class="d-flex justify-content-center">
						
						<figure class="text-center py-3">
							
							<img src="<?php echo TemplateController::srcImg() ?>views/assets/img/services/default/default-image.jpg" class="img-fluid changeImage" style="width:150px">
		        ...
		        <div class="form-group mt-2">
		        	...
		        	<label>Galleria de Servicio: <sup class="text-danger">*</sup></label> 
		        ...
		        <div class="form-group mt-2">
		        	...
		        	<label>Video Servicio | Ex: <strong>Type:</strong> YouTube, <strong>Id:</strong> Sl5FaskVpD4</label> 
		                ...
		                <div class="col-12">
		                    ...
		                    <div class="form-group__content">
		                        ...
		                        <label class="pb-5" for="topBanner">
		                           <img src="<?php echo TemplateController::srcImg() ?>views/assets/img/services/default/default-top-banner.jpg" class="img-fluid changeTopBanner">
		                        </label> 
		        ...
		        <div class="form-group mt-2">
		            ...
		            <div class="form-group__content">
		                ...
		                <label class="pb-5" for="defaultBanner">
		                   <img src="<?php echo TemplateController::srcImg() ?>views/assets/img/services/default/default-banner.jpg" class="img-fluid changeDefaultBanner" style="width:500px">
		                </label> 
		                ...
		                <div class="col-12">
		                    ...
		                    <div class="form-group__content">
		                        ...
		                        <label class="pb-5" for="hSlider">
		                           <img src="<?php echo TemplateController::srcImg() ?>views/assets/img/services/default/default-horizontal-slider.jpg" class="img-fluid changeHSlider">
		                        </label> 
		        ...
		        <div class="form-group mt-2">
		            ...
		            <div class="form-group__content">
		                ...
		                <label class="pb-5" for="vSlider">
		                    ...
		                    <img src="<?php echo TemplateController::srcImg() ?>views/assets/img/services/default/default-vertical-slider.jpg" class="img-fluid changeVSlider" style="width:260px">
