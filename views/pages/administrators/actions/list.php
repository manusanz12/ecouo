...
<div class="card">
  <div class="card-header">
    ...
    <h3 class="card-title"> 
      <a class="btn bg-dark btn-sm" href="/administrators/new">New Administrator</a>
    </h3>
  ...
  <!-- /.card-header -->
  <div class="card-body">
    <table id="adminsTable" class="table table-bordered table-striped tableAdministrator">
      <thead>
      <tr>
        <th>#</th>
        <th>Imagen</th>
