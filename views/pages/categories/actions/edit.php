			...
			<div class="form-group mt-2">
				...
				<label for="customFile" class="d-flex justify-content-center">
					...
					<figure class="text-center py-3">
						...
						<img src="<?php echo TemplateController::srcImg() ?>views/assets/img/categories/<?php echo $category->image_category ?>" class="img-fluid changePicture" style="width:150px">
