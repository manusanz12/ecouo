...
class DatatableController{
	...
	public function data(){
		...
		if(!empty($_POST)){
            ...
            $select = "id_category,image_category,name_category,title_list_category,url_category,views_category,date_created_category";
            ...
            foreach ($data as $key => $value) {
            	...
            	if($_GET["text"] == "flat"){
            	    ...
            	    $image_category = "<img src='".TemplateController::srcImg()."views/assets/img/categories/".$value->image_category."' class='img-circle' style='width:70px'>";
